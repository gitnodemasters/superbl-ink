    ...
    <div class="row">
      <div class="col-md-offset-1 col-md-10 text-center">
        ...
        <div class="col-md-12 clearfix">
        	<div class="row">
        		<p class="col-xs-push-2 col-xs-8"><?php echo e("Everyone working online should use this tool. If you are not using this tool, you are wasting time and money! More than a tool, it’s an investment and we promise the returns will EXCEED your expectations.") ?></p>
        	</div>
        </div>
  ...
  <div class="container">
    ...
    <!--<div class="row feature">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="panelette panelette-grad1">
              <h3>
                <img src="<?php echo $this->config["url"] ?>/static/img/icons/Target-Re-Target.png" alt="superbl" width="50" height="50">
          ...
          <div class="col-md-6">
            <div class="panelette panelette-grad">
              <h3>
                <img src="<?php echo $this->config["url"] ?>/static/img/icons/Measure-Optimize.png" alt="superbl" width="50" height="50">
      ...
      <div class="col-sm-5 info">
        <h2>
          <img src="<?php echo $this->config["url"] ?>/static/img/icons/Reach-Increase-Sales.png" alt="superbl" width="50" height="50">
    ...
    <div class="row feature">
        ...
        <div class="panel panel-default panel-body">
          <div class="media">
            <div class="text-center">
              <!--<i class="ti-star"></i>-->
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/blue/Target-Re-Target.png" alt="superbl" width="100" height="100">
            </div>
            <div class="media-body text-center">
              <h4><?php echo e("Target. Re-target.") ?></h4>
              <?php echo e("Target your customers to increase your reach and redirect them to a relevant page. Add a pixel to retarget them in your social media ad campaign to capture them.") ?>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="panel panel-default panel-body">
          <div class="media">
            <div class="text-center">
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/blue/Measure-Optimize.png" alt="superbl" width="100" height="100">
            </div>
            <div class="media-body text-center">
              <h4><?php echo e("Measure. Optimize.") ?></h4>
              <?php echo e("Share your links to your network and measure data to optimize your marketing campaign's performance. Reach an audience that fits your needs.") ?>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="panel panel-default panel-body">
          <div class="media">
            <div class="text-center">
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/blue/Reach-Increase-Sales.png" alt="superbl" width="100" height="100">
            </div>
            <div class="media-body text-center">
              <h4><?php echo e("Perfect for sales & marketing") ?></h4>
              <?php echo e("Understanding your users and customers will help you increase your conversion. Our system allows you to track everything. Whether it is the amount of clicks, the country or the referrer, the data is there for you to analyze it.") ?>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h1><?php echo e("Marketing with confidence"); ?></h1>
          </div>
          <div class="col-md-12 text-center">
            <div class="brands clearfix">
            <?php foreach(glob(dirname(__FILE__) . "/assets/images/brands/*.png") as $image) : ?>
            	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
            		<img src="<?php echo $this->theme("assets/images/brands/" . basename($image)) ?>" alt="">
            	</div>
            <?php endforeach; ?>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="customer">
              <p class="counter-count">7058368</p>
              <p class="customer-p"><?php echo e("Links") ?></p>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="employees">
              <p class="counter-count">23955743857</p>
              <p class="employee-p"><?php echo e("Clicks") ?></p>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="design">
              <p class="counter-count">374695</p>
              <p class="design-p"><?php echo e("Customers") ?></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row feature">
      <div class="col-md-6">
        <div class="split-content info">
          <img src="<?php echo $this->config["url"] ?>/static/img/icons/Target-Interested-Users.png" alt="superbl" width="100" height="100">
          <h2>
      ...
      <div class="col-md-6">
        <div class="split-content info">
          <img src="<?php echo $this->config["url"] ?>/static/img/icons/Control-each-everything-removebg-preview.png" alt="superbl" width="100" height="100">
          <h2>
          ...
          <div id="panel-sidebar">
            <div class="logo">
              <?php if ($this->config["logo"]) : ?>
                <img src="<?php echo $this->config["url"] ?>/content/<?php echo $this->config["logo"] ?>" alt="superbl">
              <?php else : ?>
        ...
        <div class="featurette">
          <div class="row">
            <div class="col-sm-6">
              ...
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/Targeted-Customers.png" width="60" height="60">
            ...
            <div class="col-sm-6">
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/Custom-Landing-Pages.png" width="60" height="60">
          ...
          <div class="row">
            <div class="col-sm-6">
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/Overlays.png" width="60" height="60">
            ...
            <div class="col-sm-6">
              <img src="<?php echo $this->config["url"] ?>/static/img/icons/Event-Tracking.png" width="60" height="60">
  ...
  <div class="container">
    <div class="actionbar">
      <div class="row">
        ...
        <div class="col-sm-5">
          <img src="<?php echo $this->config["url"] ?>/static/img/icons/Ready-to-get-Started.png" alt="superbl" width="250" height="200">
        </div>
      </div>
    </div>
      ...
      <div class="stats">
        ...
        <div class="row">
          <div class="col-xs-4">
            ...
            <h3><span class="thisCounter"><?php echo number_format($this->count("urls"), 0, ",", ",") ?></span>
              <p><?php echo e("Links") ?></p>
            </h3>
          </div>
          <div class="col-xs-4">
            <strong><?php echo e("Serving") ?></strong>
            <h3><span class="thisCounter"><?php echo number_format($this->count("clicks"), 0, ",", ",") ?></span>
              <p> <?php echo e("Clicks") ?></p>
            </h3>
          </div>
          <div class="col-xs-4">
            <strong><?php echo e("Trusted by") ?></strong>
            <h3><span class="thisCounter"><?php echo number_format($this->count("users"), 0, ",", ",") ?></span>
              <p><?php echo e("Customers") ?></p>
            </h3>
          </div>
        </div>
      </div>
