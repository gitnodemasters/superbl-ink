$(document).ready(function(){
   ...
   */
	...
	var forever_price_table = $('#price-tables').find('.forever');
	...
	$('.switch-toggles').find('.monthly').on('click', function(){
		...
		$(this).closest('.switch-toggles').removeClass('active1');
		$(this).siblings().removeClass('active');
		monthly_price_table.addClass('active');
		yearly_price_table.removeClass('active');
		forever_price_table.removeClass('active');
	});
	...
	$('.switch-toggles').find('.forever').on('click', function(){
		$(this).addClass('active');
		$(this).closest('.switch-toggles').addClass('active1');
		$(this).closest('.switch-toggles').removeClass('active');
		$(this).siblings().removeClass('active');
		forever_price_table.addClass('active');
		monthly_price_table.removeClass('active');
		yearly_price_table.removeClass('active');
	});
  /**
