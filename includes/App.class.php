...
class App{
	...
	protected $actions = ["user","page","Terms","Privacy","whatissuperblink","contact","server","pricing","upgrade" ,"analytic","profile","ipn", "q", "jShortener", "webhook","api", "scriptjs", "r","blog", "report", "u"];
	/**
	 * User Variables
	 * @since 4.0
	 **/
	...
	// page:
	protected function whatissuperblink (){
		$this->do = "whatissuperblink";
		$this->page();
	}
